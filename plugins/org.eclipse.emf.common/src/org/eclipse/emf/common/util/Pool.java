 ...
 */
  private int calculateNumberOfSegmets() {
    int segmentCount = 1;
    String concurrencyLevelString = System.getProperty("org.eclipse.emf.common.util.Pool.concurrencyLevel");
    int concurrencyLevel = concurrencyLevelString != null ? Integer.parseInt(concurrencyLevelString) : 1;
